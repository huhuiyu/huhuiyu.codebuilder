package top.huhuiyu.codebuilder.template.config;
...
import top.huhuiyu.codebuilder.template.aop.ControllerToken;
...
public class SwaggerConfig {
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder().title("huhuiyu.codebuilder.template").description("huhuiyu.codebuilder.template").version("1.0.0").build();
  }
