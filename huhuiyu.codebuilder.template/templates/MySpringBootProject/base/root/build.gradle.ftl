...
buildscript {
  repositories {
    ...
    //自建私有仓库
    maven {url 'https://maven.huhuiyu.top/repository/huhuiyu/'}
    //使用官方maven仓库
    mavenCentral()
  }
...
dependencies {
  ...
  // websocket
  compile group: 'org.springframework.boot', name: 'spring-boot-starter-websocket', version: '2.2.6.RELEASE'
  // huhuiyu.api
  compile group: 'top.huhuiyu.api', name: 'huhuiyu-fileutils', version: '1.1.0'
  compile group: 'top.huhuiyu.api', name: 'huhuiyu-utils', version: '1.1.2'
  compile group: 'top.huhuiyu.api', name: 'huhuiyu-spring', version: '1.0.4'
